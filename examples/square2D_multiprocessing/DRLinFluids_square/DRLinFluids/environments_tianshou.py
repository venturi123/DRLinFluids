...
class OpenFoam_tianshou(gym.Env):
	...
	def reward_function(self):
		...
		print(1.549 - drug_coeffs_sliding_average, 0.1 * np.abs(lift_coeffs_sliding_average))
		return 1.549 - drug_coeffs_sliding_average - 0.1 * np.abs(lift_coeffs_sliding_average)
