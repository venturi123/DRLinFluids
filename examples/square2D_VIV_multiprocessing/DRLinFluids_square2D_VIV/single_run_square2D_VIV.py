...
def test_sac_with_il(args=get_args()):
    ...
    foam_params = {
        ...
        "cfd_init_time": 0.0125,  # 初始化流场，初始化state
        "num_dimension": 2,
        "verbose": False,
    }
    ...
    entry_dict_t0 = {"U": {"back1": {"t0": "{t}"}, "back2": {"t0": "{t}"}}}
    ...
    env = envobject_square2D_VIV.FlowAroundSquareCylinder2D(
