...
class BasePolicy(ABC, nn.Module):
    ...
    * :meth:`~tianshou.policy.BasePolicy.update`: the main interface for training, \
    ...
    def __init__(
        ...
        env_state_shape: Optional[gym.Space] = None,
        sourceenv_state_shape: Optional[gym.Space] = None,
        old_policy: Optional[gym.Space] = None,
        old_policy_actor: Optional[gym.Space] = None,
        old_policy_critic1: Optional[gym.Space] = None,
        old_policy_critic1_old: Optional[gym.Space] = None,
        old_policy_critic2: Optional[gym.Space] = None,
        old_policy_critic2_old: Optional[gym.Space] = None,
    ) -> None:
        super().__init__()
